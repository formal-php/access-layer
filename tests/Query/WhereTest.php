...
class WhereTest extends TestCase
{
    ...
    public function testWhereStartsWithComparator()
    {
        $this
            ->forAll(Column::any(), Set\Strings::any())
            ->then(function($column, $value) {
    ...
    public function testWhereEndsWithComparator()
    {
        $this
            ->forAll(Column::any(), Set\Strings::any())
            ->then(function($column, $value) {
    ...
    public function testWhereContainsComparator()
    {
        $this
            ->forAll(Column::any(), Set\Strings::any())
            ->then(function($column, $value) {
